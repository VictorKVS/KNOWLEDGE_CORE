...
## 17. Ролевые базы знаний

Аналитический центр использует [FATHER Role Knowledge System](./FATHER_ROLE_KNOWLEDGE_SYSTEM.md). Каждая виртуальная должность получает собственную проекцию знаний и проходит уровни L0–L5; общие источники и узлы не копируются.
