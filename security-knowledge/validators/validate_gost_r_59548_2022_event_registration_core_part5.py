...
MODEL = Path("security-knowledge/standards/gost-r-59548-2022-event-registration-core-part5-v1.yaml")
FIXTURES = Path("security-knowledge/standards/gost-r-59548-2022-event-registration-core-part5-regression-v1.json")
...
def main():
    ...
    def evaluate(case):
        ...
        if query == "modeled_clause_boundary": return model["verification_boundary"]["clauses_6_2_45_to_6_2_56"]
        if query == "remaining_clause_boundary": return model["verification_boundary"]["clauses_6_2_57_to_6_2_81"]
    ...
    assert model["status"] == "VERIFIED_BOUNDED_PARTIAL_CLAUSE_MODEL_6_2_45_TO_6_2_56"
    assert list(schemas) == [f"G59548-6.2.{i}" for i in range(45, 57)]
    failures = []
    ...
    if failures:
        ...
        raise SystemExit(1)
    print("PASS: 12 schemas; 68 required and 52 additional placements; cumulative 56/81; 64 fail-closed cases")
