...
MODEL = Path("security-knowledge/standards/gost-r-59548-2022-event-registration-core-part4-v1.yaml")
FIXTURES = Path("security-knowledge/standards/gost-r-59548-2022-event-registration-core-part4-regression-v1.json")
...
def main():
    ...
    def evaluate(case):
        ...
        if query == "modeled_clause_boundary": return model["verification_boundary"]["clauses_6_2_33_to_6_2_44"]
        if query == "remaining_clause_boundary": return model["verification_boundary"]["clauses_6_2_45_to_6_2_81"]
    ...
    assert model["status"] == "VERIFIED_BOUNDED_PARTIAL_CLAUSE_MODEL_6_2_33_TO_6_2_44"
    assert list(schemas) == [f"G59548-6.2.{i}" for i in range(33, 45)]
    failures = []
    ...
    if failures:
        ...
        raise SystemExit(1)
    print("PASS: 12 schemas; 69 required and 51 additional placements; cumulative 44/81; 64 fail-closed cases")
