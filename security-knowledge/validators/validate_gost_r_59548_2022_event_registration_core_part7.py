...
MODEL = Path("security-knowledge/standards/gost-r-59548-2022-event-registration-core-part7-v1.yaml")
FIXTURES = Path("security-knowledge/standards/gost-r-59548-2022-event-registration-core-part7-regression-v1.json")
...
def main():
    ...
    def evaluate(case):
        ...
        if query == "modeled_clause_boundary": return model["verification_boundary"]["clauses_6_2_69_to_6_2_81"]
    ...
    assert model["status"] == "VERIFIED_BOUNDED_PUBLIC_TEXT_CLAUSE_MODEL_6_2_69_TO_6_2_81"
    assert list(schemas) == [f"G59548-6.2.{i}" for i in range(69, 82)]
    failures = []
    ...
    if failures:
        ...
        raise SystemExit(1)
    print("PASS: 13 schemas/rules; 69 required and 49 additional placements; cumulative 81/81; 64 fail-closed cases")
