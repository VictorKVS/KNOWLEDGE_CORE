...
assert m['formula_status']['state']=='PENDING_PRIMARY_PDF_FORMULA_TRANSCRIPTION' and len(m['formula_status']['formula_points'])==10
...
print('PASS: PP92 points 1-55, 21 indicator routes, 2 deadlines/2 recipients, 8 gates/scenarios, 18 evidence nodes, 12/12 attacks, 64/64 rules/cases; 10 formulas fail closed')
